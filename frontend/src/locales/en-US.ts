...
export default {
  ...
  webhook: {
    ...
    description:
      'Push a signed notification to the configured callback URL when a task reaches a terminal state (admin only)',
    enabled: 'Enable Webhook Notifications',
    enabledHelp: 'When enabled, a JSON notification with an HMAC signature is POSTed on task completion or failure',
    url: 'Callback URL',
    ...
    authSecretPlaceholder: 'Configured; leave unchanged to keep current value',
    eventCompleted: 'Task Completed (task.completed)',
    eventFailed: 'Task Failed (task.failed)',
    timeout: 'Timeout (s)',
